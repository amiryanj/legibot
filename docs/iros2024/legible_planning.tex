...
%    \textit{Contrib (1):} Simulating Observer's Viewpoint:
%    Adding f(t) (a descending function of time) to the legibility function, to maximize the legibility of the motion at the beginning of the motion, does not always work.
%    We also consider the saliency of the motion in computing the legibility of a motion.
%    Imagine doing a motion far from the observer, is not a salient motion, and the observer does not pay attention to it,
%    even though it is still considered legible in the previous works, and is still in the field of view of the observer.
    %
    ...
    %For this we have studied a short-term motion prediction method
    %and a long-term goal prediction algorithm in an effort to cover the gap in the existing research
    %in addressing the visual inputs of a human observer for computing legibility.
...
%    \noindent
%    \textbf{Discussion:}
%    In [DRAGAN] the idea of using $f(t)$ was proposed to encourage the robot to maximize the legibility at the beginning of the motion.
...
%    \section{Proposed Method}
    ...
    \noindent
    \subsection{Contrib (2): Synthesis} %New way to generate legible motions for mobile robots:
    %%%%%%%%%%%%%%%%%%%%
...
%    \section{TODO}
%    - To improve the robot-restaurants scenario simulation.
%    - To
...
%    and then in section [REF] we explain the experiments we conducted with simulated and real robots
%     to demonstrate the effectiveness of our proposed methodology in a restaurant scenario.
